...
class ProductRepository {
    public function insert($name, $price, $discount, $description, $thumbnail, $category_id) {
        global $conn;
        $sql = "INSERT INTO product (product_name, product_price, product_discount, product_description, product_thumbnail_image, product_category_id) 
                VALUES ('$name', $price, $discount, '$description', '$thumbnail', $category_id)";
    ...
    public function update($id, $name, $price, $discount, $description, $thumbnail, $category_id) {
        global $conn;
        $sql = "UPDATE product 
